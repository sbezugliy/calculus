...
Gem::Specification.new do |spec|
  spec.name          = "calculus"
  spec.version       = Calculus::VERSION
  spec.authors       = ["Sergey Bezugliy"]
  spec.email         = ["s.bezugliy@gmail.com"]

  spec.summary       = "calculus"
  spec.description   = "calculus"
  ...
  spec.add_development_dependency "flammarion", "~> 0.3.0"
  spec.add_development_dependency "colorized"

  spec.add_runtime_dependency "flammarion", "~> 0.3.0"
  spec.add_runtime_dependency "colorized"
end
